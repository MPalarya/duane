...
export default async function SpotlightPage() {
  let people = (await safeFetch<SpotlightPerson[]>(spotlightPeopleQuery)) ?? [];
  if (people.length === 0) {
    people = seedSpotlightPeople;
  }

  let advocates = (await safeFetch<FeaturedAdvocate[]>(featuredAdvocatesQuery)) ?? [];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-warm-900">Spotlight</h1>
